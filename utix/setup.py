...
setup(
    name='utix',  # How you named your package folder (MyLib)
    packages=['utix'],  # Chose the same as "name"
    version='0.1',  # Start with a small number and increase it with every change you make
    license='MIT',  # Chose a license from here: https://help.github.com/articles/licensing-a-repository
    description='initial release',  # Give a short description about your library
    author='Tony Chen',  # Type in your name
    author_email='zc86@drexel.edu',  # Type in your E-Mail
